...
class CreateAgentLevelsTable extends Migration
{
    public function up()
    {
        Schema::create('agent_levels', function (Blueprint $table) {
            ...
            $table->string('level_name', 100)->nullable()->comment('level_name');
            $table->string('level_code', 50)->nullable()->comment('level_code');
            $table->decimal('commission_rate', 5, 2)->default(0)->comment('commission_rate');
